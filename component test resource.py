...
resourcenameentry =tk.Entry(frame1,width=30,justify="left").pack(anchor="w",pady=10)
...
finishsetupbutton = tk.Button(frame2,text="Finish setup",command=testcommand,font=("Helevitica","17"),bg="#008A00").pack(side="bottom",anchor="e",pady=5)
addresourcebutton = tk.Button(frame2,text="Add resource",command=testcommand,font=("Helevitica","17"),bg="#0050EF").pack(side="bottom",anchor="w",pady=5)
while True:
